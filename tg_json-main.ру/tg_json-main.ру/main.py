...
bot = TeleBot(token='нельзя вставлять в репозиторий', parse_mode='html') # создание бота
...
def start_command_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        text='Привет,друг! Давай проверим твой JSON и отформатируем его в красивый текст\nВведи JSON в виде строки:', # текст сообщения
    )
